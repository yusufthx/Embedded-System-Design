//https://www.hackster.io/Arnov_Sharma_makes/arduino-game-jump-or-lose-i2c-2c9f5a
// SCHEME
...
// GND - GND
// VCC - 5V
/*In this game, the hero need to avoid the obstable by jumping over the obstacle 
 * or down under the obstacles.
 */
